...
const About = () => {
  ...
  return (
    <section
      id="about"
      ref={sectionRef}
      className="min-h-screen flex flex-col md:flex-row items-center justify-center gap-12 px-6 md:px-16 py-20
    ...
    >
      ...
      <div className="flex-1 text-center md:text-left space-y-6">
        ...
        >
          Hi! I’m Tensae Deme. I love building <strong>modern web and mobile applications</strong> that people actually enjoy using.  
          On top of that, I’m passionate about <strong>DevOps</strong>, making sure applications run smoothly, scale effortlessly, and stay reliable.  
          My work is all about connecting <strong>development and operations</strong>, creating seamless user experiences, and solving real-world problems efficiently.
        </p>
        <div
